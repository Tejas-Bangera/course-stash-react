...
app.get("/admin/courses/:courseId", validateJWT, async (req, res) => {
  const courseId = req.params.courseId;
  try {
    // Get courses of only that admin
...
// Admin validate jwt
app.get("/user/validatejwt", validateJWT, (req, res) => {
  res.json({ message: "JWT Validated!", username: req.user.username });
});
...
app.post("/user/courses/all", validateJWT, async (req, res) => {
  // logic to purchase a course
...
app.post("/users/cart/:courseId", validateJWT, async (req, res) => {
  // logic to purchase a course
  const courseId = req.params.courseId;
...
app.delete("/users/cart/:courseId", validateJWT, async (req, res) => {
  // logic to purchase a course
  const courseId = req.params.courseId;
...
app.get("/users/cart", validateJWT, async (req, res) => {
